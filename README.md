...
First of all, the .d files should be converted to mzML format using msconvert with option '--combineIonMobilitySpectra'. **Please, do not use option `--filter "scanSumming"`!** The latter is often required for MS/MS data analysis but breaks MS1 feature detection.
