...
def run():
    ...
    parser.add_argument('-ac', '--mass_accuracy', help='Mass accuracy', default=7)
    parser.add_argument('-minc', '--min_charge', help='Minimum charge', default=1)
    parser.add_argument('-maxc', '--max_charge', help='Maximum charge', default=5)
    parser.add_argument('-minl', '--min_length', help='Minimum length', default=3)
    parser.add_argument('-mini', '--min_intensity', help='Minimum intensity', default=10)
